...
<header class="site-navbar pd-0">
		...
		<nav class="site-nav hidden-xxs hidden-xs hidden-sm">
			<ul class="cl-effect-5">
				...
				<li>
					<a class="menu-smooth-scroll" href="#we_belive_in"><span data-hover="We Belive In"><span>We Belive In</span></span></a>
				</li>
				<li>
					<a class="menu-smooth-scroll" href="#FEATURE_BRANDS"><span data-hover="FEATURE BRANDS"><span>FEATURE BRANDS</span></span></a>
				</li>
				<li>
					<a class="menu-smooth-scroll" href="#FEATURED_SERVICES"><span data-hover="FEATURED SERVICES"><span>FEATURED SERVICES</span></span></a>
				</li>
				<!--<li>-->
				<!--	<a class="menu-smooth-scroll" href="#MAJOR_PRODUCTS"><span data-hover="MAJOR PRODUCTS"><span>FEATURE PRODUCTS</span></span></a>-->
				<!--</li>-->
				<li>
					<a class="menu-smooth-scroll" href="#MAJOR_CLIENTS"><span data-hover="MAJOR CLIENTS"><span>MAJOR CLIENTS</span></span></a>
				</li>


                <li>
					<a class="menu-smooth-scroll" href="#AWARDS"><span data-hover="AWARDS"><span>AWARDS</span></span></a>
				</li>
				
				<li>
					<a class="menu-smooth-scroll" href="#LEADERSHIP"><span data-hover="LEADERSHIP"><span>LEADERSHIP</span></span></a>
				</li>
